...
Docker dev stack (MongoDB, Qdrant, mock SAML IdP), typed + validated config,
...
| Task 2 (docker stack) | Stephen → Saurav's Task 11 | Saurav's ingestion spike needs the compose stack. Merge Task 2 early. |
...
- [ ] Toolkit versions pinned exactly (Task 1); compose stack up for Saurav's spike (Task 2).
