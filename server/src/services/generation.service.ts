...
export function GENERATOR_PROMPT(params: {
  ...
  return [
    ...
    '     $$500 \\times ...$$',
    'Prose stays prose; only the formulas are LaTeX. An explanation that shows its',
    'working is the whole point of this field, so prefer a display line over',
    'describing the arithmetic in words.',
    '',
